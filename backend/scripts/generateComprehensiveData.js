// Helper script to generate comprehensive symptoms and diseases data
// This data will be used to update the seed database
...
export const additionalSymptoms = [
  ...
  { name: 'Coughing up mucus', category: 'respiratory', severity: 'moderate', description: 'Producing phlegm when coughing', commonNames: ['productive cough'] },
  { name: 'Chest tightness', category: 'respiratory', severity: 'moderate', description: 'Feeling of pressure in chest', commonNames: ['tight chest'] },
  ...
  { name: 'Blurred vision', category: 'neurological', severity: 'moderate', description: 'Lack of sharpness in vision', commonNames: ['vision problems'] },
  { name: 'Vision loss', category: 'neurological', severity: 'severe', description: 'Loss of sight', commonNames: ['blindness'] },
  ...
  { name: 'Jaundice', category: 'digestive', severity: 'severe', description: 'Yellowing of skin and eyes', commonNames: ['yellow skin'] },
  ...
  // Additional Musculoskeletal Symptoms
  ...
  { name: 'Skin lesion changes', category: 'dermatological', severity: 'severe', description: 'Changes in moles or skin lesions', commonNames: ['melanoma'] },
  { name: 'Asymmetric lesion', category: 'dermatological', severity: 'severe', description: 'Asymmetrical skin lesion', commonNames: ['irregular mole'] },
  { name: 'Irregular border lesion', category: 'dermatological', severity: 'severe', description: 'Lesion with irregular edges', commonNames: ['irregular mole'] },
  { name: 'Uneven color lesion', category: 'dermatological', severity: 'severe', description: 'Lesion with multiple colors', commonNames: ['multicolored mole'] },
  { name: 'Large diameter lesion', category: 'dermatological', severity: 'severe', description: 'Lesion larger than 6mm', commonNames: ['large mole'] },
  { name: 'Evolving lesion', category: 'dermatological', severity: 'severe', description: 'Changing mole or lesion', commonNames: ['changing mole'] },
  ...
  // Additional Reproductive Symptoms
...
console.log(`Generated ${additionalSymptoms.length} additional symptoms`);
